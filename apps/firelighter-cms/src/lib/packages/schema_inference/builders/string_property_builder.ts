import type { Property, StringProperty, FileType } from "$lib/packages/firecms_core/types/properties";
import type { InferencePropertyBuilderProps, ValuesCountEntry } from "../types";
