...
import type { EntityValues, EntityStatus } from "../types/entities";
import type { Property, CMSType, PropertyOrBuilder, PropertyBuilder, PropertiesOrBuilders, Properties, DataType } from "../types/properties";
import type { ResolvedProperty, ResolvedProperties } from "../types/resolved_entities";
