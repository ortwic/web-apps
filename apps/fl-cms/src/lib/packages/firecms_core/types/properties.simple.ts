...
export interface MapProperty<T extends Record<string, CMSType> = Record<string, CMSType>> extends BaseProperty<T> {
    ...
    /**
     * Render this map as a key-value table that allows to use arbitrary keys. 
     * You can define column names to make the values multidimensional.
     * You don't need to define the properties in this case.
     */
    keyValue?: boolean | [];
