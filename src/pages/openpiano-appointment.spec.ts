...
describe('open piano module', () => {
  ...
  it('should parse appointment', () => {
    ...
    expect(result.start?.dateTime).toBe('2023-08-19T13:00');
    expect(result.end?.dateTime).toBe('2023-08-19T21:00');
  ...
  it('should parse appointment range', () => {
    ...
    expect(result.start?.dateTime).toBe('2023-08-24T11:00');
    expect(result.end?.dateTime).toBe('2023-08-27T21:30');
  ...
  it('should parse appointment range over month', () => {
    ...
    expect(result.start?.dateTime).toBe('2023-08-31T12:00');
    expect(result.end?.dateTime).toBe('2023-09-03T20:00');
  ...
  it('should parse appointment range over year', () => {
    ...
    expect(result.start?.dateTime).toBe('2023-12-31T12:00');
    expect(result.end?.dateTime).toBe('2024-01-03T20:00');
    expect(result.location).toBe('Graz (AT) – Franziskanerplatz');
  });
});